...
def RPP_4_mark_test():
    ...
    def rpp_4_docId():
        ...
        try:
            ...
            db_ins2 = DB_placer(config['transportDB']['db_name'],
                               config['transportDB']['db_user'],
                               config['transportDB']['db_password'],
                               config['transportDB']['db_host'],
                               config['transportDB']['db_port'])
    ...
    def rpp_4_json_send():
        ...
        try:
            sender = Kafka_sender(forming.doc_type,
                                  params[1],
                                  topic=config['kafka']['ibark_topic'],
                                  docId=forming.docId,
...
def AWO_3_mark_test():
    ...
    def awo_3_get_bcode():
        ...
        try:
            db_ins = DB_placer(config['codesDB']['db_name'],
                               config['codesDB']['db_user'],
                               config['codesDB']['db_password'],
                               config['codesDB']['db_host'],
                               config['codesDB']['db_port'])
    ...
    def awo_3_get_formb():
        ...
        try:
            ...
            while FB == "":
                ...
                db_ins2 = DB_placer(config['codesDB']['db_name'],
                                   config['codesDB']['db_user'],
                                   config['codesDB']['db_password'],
                                   config['codesDB']['db_host'],
                                   config['codesDB']['db_port'])
                ...
                db_ins3 = DB_placer(config['codesDB']['db_name'],
                                   config['codesDB']['db_user'],
                                   config['codesDB']['db_password'],
                                   config['codesDB']['db_host'],
                                   config['codesDB']['db_port'])
...
@testReport.stepResults.title("СМОК-тестирование waybill_v4 немаркированная фасованная")
def TTN_4_isPacked_test():
    ...
    def ttn_4_getForm():
        ...
        try:
            ...
            # Не нужно, так как немаркируемая продукция => марки нет
